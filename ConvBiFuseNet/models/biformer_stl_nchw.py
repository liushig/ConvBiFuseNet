...
from models._common import nchwAttentionLePE, AttentionLePE
...
class nchwBiFormerSTL(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 drop_path_rate=0.65, drop_rate=0.,
        ...
        stem = nn.Sequential(nn.Conv2d(in_chans, embed_dim[0], kernel_size=4, stride=4),
...
#                             **kwargs)
    ...
    # return model
# model_instance = biformer_stl_nchw()
